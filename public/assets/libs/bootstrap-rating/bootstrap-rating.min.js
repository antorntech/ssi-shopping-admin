  ...
  (c.prototype = {
    _init: function () {
      for (
        ...
        var h = a('<div className="rating-symbol"></div>').css({
          display: "inline-block",
          position: "relative",
        });
        a(
          '<div className="rating-symbol-background ' +
            this.options.empty +
            '"></div>'
        ).appendTo(h),
          a('<div className="rating-symbol-foreground"></div>')
            .append("<span></span>")
            .css({
              display: "inline-block",
              position: "absolute",
          ...
          var d = a(b.currentTarget),
            e = Math.abs(
              (b.pageX || b.originalEvent.touches[0].pageX) -
                (("rtl" === d.css("direction") && d.width()) + d.offset().left)
            );
          return (

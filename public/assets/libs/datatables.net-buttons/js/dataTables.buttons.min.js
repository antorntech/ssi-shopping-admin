  ...
  y.extend(B.prototype, {
    ...
    add: function (t, n, e) {
      ...
      return (
        this._expandButton(
          ...
          t,
          t !== w ? t.split : w,
          (t === w || t.split === w || 0 === t.split.length) && s !== w,
          !1,
          n
        ),
        (e !== w && !0 !== e) || this._draw(),
        ...
        if (p)
          if (((r = !(!p.config || !p.config.split)), Array.isArray(p)))
            ...
            var h = this._buildButton(
              p,
              o,
              p.split !== w || (p.config !== w && p.config.split !== w),
              i
            );
            if (h) {
              if (
    ...
    _buildButton: function (n, t, e, o) {
      ...
      return (
        ...
        e &&
          ((p = (f = t
            ? y.extend(!0, this.c.dom.split, this.c.dom.collection.split)
          ...
          (m = y(
            ...
            .on("keypress.dtb", function (t) {
              13 === t.keyCode &&
                (t.preventDefault(), m.hasClass(d.disabled) || g(t, u, m, b));
            })),
    ...
    _popover: function (o, t, n, e) {
      ...
      !1 === o
        ...
        : ((p = y(
          ...
          b.popoverTitle
            ? s.prepend(
                '<div className="dt-button-collection-title">' +
                  b.popoverTitle +
                  "</div>"
              )
            : b.collectionTitle &&
          ...
          b.closeButton &&
            s
              .prepend('<div className="dtb-popover-close">&times;</div>')
          ...
          "absolute" === d
            ? ((p = y(m[0].offsetParent)),
              ...
              ("dt-container" !== b.align && "container" !== b.align) ||
                ((c = c < t.left ? -t.left : c) + u.width > a.width &&
                  (c = a.width - u.width)),
              r.left + c + u.width > y(v).width() &&
                (c = y(v).width() - u.width - r.left),
              n.left + c < 0 && (c = -n.left),
              r.top + p + u.height > y(v).height() + y(v).scrollTop() &&
    ...
    (B.defaults = {
      ...
      dom: {
        ...
        collection: {
          action: {
            dropHtml: '<span className="dt-button-down-arrow">&#x25BC;</span>',
          },
          container: {
    ...
    e.Api.register("buttons().containers()", function () {
      ...
      return (
        this.iterator(!0, "table", function (t) {
          if (t._buttons)
            for (
              var n = B.instanceSelector(s, t._buttons), e = 0, o = n.length;
              e < o;
              e++
            )
    ...
    e.Api.register("button().add()", function (t, n, e) {
      ...
      return (
        o.length &&
          (o = B.instanceSelector(this._groupSelector, o[0]._buttons)).length &&
          o[0].add(n, t, e),

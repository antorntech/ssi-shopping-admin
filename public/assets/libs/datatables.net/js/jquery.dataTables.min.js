...
!(function (n) {
  ...
  function Lt(n) {
    ...
    var t = n.oClasses,
      ...
      o = n.oPreviousSearch,
      i = n.aanFeatures,
      l = '<input type="search" className="' + t.sFilterInput + '"/>',
  ...
  function Qt(n) {
    ...
    n.scrollBarVis !== R && n.scrollBarVis !== H
      ...
      : ((n.scrollBarVis = R),
        ...
        k(function (t, e) {
          (t.innerHTML =
            '<div className="dataTables_sizing">' + F[e] + "</div>"),
        ...
        C &&
          k(function (t, e) {
            (t.innerHTML =
              '<div className="dataTables_sizing">' + L[e] + "</div>"),
              (t.childNodes[0].style.height = "0"),
              (t.childNodes[0].style.overflow = "hidden"),
              (t.style.width = I[e]);
          }, a),
          ...
          function h(t, e) {
            for (
              ...
              if (((n = e[o]), Array.isArray(n))) {
                ...
                switch (((p = null), (g = n))) {
                  case "ellipsis":
                    t.append('<span className="ellipsis">&#x2026;</span>');
                    break;
                  case "first":
                    (p = m.sFirst), 0 === f && (s = !0);
                    break;

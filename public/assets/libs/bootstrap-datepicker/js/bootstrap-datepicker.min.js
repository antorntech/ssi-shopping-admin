!(function (a) {
    ...
    fillDow: function () {
      if (this.o.showWeekDays) {
        var b = this.o.weekStart,
          c = "<tr>";
        for (
          this.o.calendarWeeks && (c += '<th className="cw">&#160;</th>');
  ...
  var q = (a.fn.datepicker.dates = {
    ...
    r = {
      ...
      headTemplate:
        '<thead><tr><th colspan="7" className="datepicker-title"></th></tr><tr><th className="prev">' +
        o.templates.leftArrow +
        '</th><th colspan="5" className="datepicker-switch"></th><th className="next">' +
  ...
  (r.template =
    '<div className="datepicker"><div className="datepicker-days"><table className="table-condensed">' +
    r.headTemplate +
    "<tbody></tbody>" +
    r.footTemplate +
    '</table></div><div className="datepicker-months"><table className="table-condensed">' +
    r.headTemplate +
    r.contTemplate +
    r.footTemplate +
    '</table></div><div className="datepicker-years"><table className="table-condensed">' +
    r.headTemplate +
    r.contTemplate +
    r.footTemplate +
    '</table></div><div className="datepicker-decades"><table className="table-condensed">' +
    r.headTemplate +
    r.contTemplate +
    r.footTemplate +
    '</table></div><div className="datepicker-centuries"><table className="table-condensed">' +
    r.headTemplate +
    r.contTemplate +
    r.footTemplate +
    "</table></div></div>"),

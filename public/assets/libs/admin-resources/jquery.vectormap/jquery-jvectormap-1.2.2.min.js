...
(jvm.$ = jQuery),
  ...
  (jvm.AbstractCanvasElement.prototype.addGroup = function (e) {
    ...
    return (
      e ? e.node.appendChild(t.node) : this.node.appendChild(t.node),
      (t.canvas = this),
      t
    );
  }),
  ...
  (jvm.AbstractShapeElement.prototype.setSelected = function (e) {
    this.isSelected !== e &&
      ((this.isSelected = e),
      this.updateStyle(),
      jvm.$(this.node).trigger("selected", [e]));
  }),
  (jvm.AbstractShapeElement.prototype.setStyle = function (e, t) {
    var n = {};
    typeof e == "object" ? (n = e) : (n[e] = t),
    ...
    try {
      document.namespaces.rvml ||
        ...
        (jvm.VMLElement.prototype.createElement = function (e) {
          return document.createElement("<rvml:" + e + ' className="rvml">');
        });
    } catch (e) {
      jvm.VMLElement.prototype.createElement = function (e) {
        return document.createElement(
          "<" + e + ' xmlns="urn:schemas-microsoft.com:vml" className="rvml">'
        );
      };
    }
  ...
  (jvm.VMLShapeElement.prototype.applyAttr = function (e, t) {
    switch (e) {
      ...
      case "fill-opacity":
        ...
        break;
      case "stroke":
        t === "none" ? (this.node.stroked = !1) : (this.node.stroked = !0),
  ...
  (jvm.ColorScale.prototype.getValue = function (e) {
    return jvm.ColorScale.numToRgb(
      jvm.ColorScale.parentClass.prototype.getValue.call(this, e)
    );
  }),
  ...
  (jvm.DataSeries = function (e, t) {
    ...
    (e = e || {}),
      ...
      jvm.$.isArray(e.scale)
        ? ((n =
            e.attribute === "fill" || e.attribute === "stroke"
              ? jvm.ColorScale
              : jvm.NumericScale),
      ...
      if (
        ...
        for (i in e)
          e[i]
            ...
            : (s[i] =
                this.elements[i].element.style.initial[this.params.attribute]);
      else {
  ...
  (jvm.Proj = {
    ...
    mill: function (e, t, n) {
      return {
        ...
        y:
          (-this.radius * Math.log(Math.tan((45 + 0.4 * e) * this.radDeg))) /
          0.8,
      };
    },
    ...
    lcc: function (e, t, n) {
      var r = 0,
        ...
        f =
          ...
          Math.log(
            Math.tan(Math.PI / 4 + u / 2) * (1 / Math.tan(Math.PI / 4 + o / 2))
          ),
    ...
    lcc_inv: function (e, t, n) {
      var r = e / this.radius,
        ...
        f =
          ...
          Math.log(
            Math.tan(Math.PI / 4 + a / 2) * (1 / Math.tan(Math.PI / 4 + u / 2))
          ),
      ...
      return {
        lat:
          (2 * Math.atan(Math.pow(l / h, 1 / f)) - Math.PI / 2) * this.degRad,
        lng: (o + p / f) * this.degRad,
      };
    },
  }),
  (jvm.WorldMap = function (e) {
    ...
    for (n in jvm.WorldMap.apiEvents)
      this.params[n] &&
        this.container.bind(
          jvm.WorldMap.apiEvents[n] + ".jvectormap",
          this.params[n]
        );
  ...
  (jvm.WorldMap.prototype = {
            ...
            t.type == "mouseover"
              ? (e.container.trigger(f, [s]),
                ...
                a.isDefaultPrevented() ||
                  (e.label.show(),
                  (e.labelWidth = e.label.width()),
                  (e.labelHeight = e.label.height())))
              : (o.setHovered(!1),
                e.label.hide(),
                e.container.trigger(i + "Out.jvectormap", [s]));
          }
        ),
        this.container.delegate(
          "[class~='jvectormap-element']",
      ...
      e > this.params.zoomMax * this.baseScale
        ...
        typeof t != "undefined" &&
          ...
          r
            ? ((this.transX =
                t +
                (this.defaultWidth * (this.width / (this.defaultWidth * e))) /
                  2),
              (this.transY =
                n +
                (this.defaultHeight *
                  (this.height / (this.defaultHeight * e))) /
                  2))
            : ((this.transX -= ((i - 1) / e) * t),
              (this.transY -= ((i - 1) / e) * n))),
        (this.scale = e),
    ...
    setFocus: function (e, t, n) {
      ...
      if (jvm.$.isArray(e) || this.regions[e]) {
            ...
            i &&
              (typeof r == "undefined"
                ...
                : ((s = {
                    ...
                    y: Math.min(r.y, i.y),
                    width:
                      Math.max(r.x + r.width, i.x + i.width) -
                      Math.min(r.x, i.x),
                    height:
                      Math.max(r.y + r.height, i.y + i.height) -
                      Math.min(r.y, i.y),
                  }),
                  (r = s))));
        this.setScale(
        ...
        (e *= this.baseScale),
          this.setScale(e, -t * this.defaultWidth, -n * this.defaultHeight, !0);
    },
      ...
      return (
        ...
        u
          ? ((a = u.bbox),
            ...
            (n.y =
              ((n.y - a[0].y) / (a[1].y - a[0].y)) * u.height * this.scale),
            {

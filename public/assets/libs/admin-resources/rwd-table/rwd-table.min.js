...
!(function (d) {
  ...
  var a = function (t, i) {
    ...
    if (
      ...
      (this.$tableScrollWrapper = d(t)),
      (this.$table = d(t).find("table")),
      1 !== this.$table.length)
    )
      throw new Error(
    ...
    this.$tableScrollWrapper.attr("data-pattern", this.options.pattern),
      ...
      d(window)
        .bind(
          "orientationchange resize " + this.displayAllTrigger,
          function () {
            e.$dropdownContainer.find("input").trigger("updateCheck"),
              d.proxy(e.updateSpanningCells(), e);
          }
        )
        .trigger("resize");
  };
  (a.DEFAULTS = {
    ...
    (a.prototype.wrapTable = function () {
      this.$tableScrollWrapper.wrap('<div className="table-wrapper"/>'),
    ...
    (a.prototype.createButtonToolbar = function () {
      ...
      (this.$btnToolbar = d(
        ...
        0 === this.$btnToolbar.length &&
          (this.$btnToolbar = d('<div className="btn-toolbar" />')),
        (this.$dropdownGroup = d(
          '<div className="btn-group dropdown-btn-group pull-right" />'
        )),
        (this.$dropdownBtn = d(
        ...
        (this.$dropdownContainer = d('<ul className="dropdown-menu"/>')),
        this.options.addFocusBtn &&
          ...
          this.options.focusBtnIcon &&
            this.$focusBtn.prepend(
              '<span className="' + this.options.focusBtnIcon + '"></span> '
            ),
    ...
    (a.prototype.focusOnRow = function (t) {
      if (this.$table.hasClass("focus-on")) {
        ...
        this.clearAllFocus(),
          i || (this.$bodyRows.addClass("unfocused"), d(t).addClass("focused"));
      }
    }),
    ...
    (a.prototype.preserveDisplayAll = function () {
      var t = "table-cell";
      d("html").hasClass("lt-ie9") && (t = "inline"),
        d(this.$table).find("th, td").css("display", t),
        this.$tableClone &&
          d(this.$tableClone).find("th, td").css("display", t);
    }),
    (a.prototype.createStickyTableHeader = function () {
      ...
      (i.$tableClone = i.$table.clone()),
        ...
        i.$tableClone.wrap('<div className="sticky-table-header"/>'),
        ...
        i.useFixedSolution
          ? i.$tableScrollWrapper.addClass("fixed-solution")
          : i.$tableScrollWrapper.addClass("absolute-solution");
    }),
    (a.prototype.updateStickyTableHeader = function () {
      var t,
        ...
        l = 0;
      d(i.options.fixedNavbar).length &&
        (a += l = d(i.options.fixedNavbar).first().height());
      if (
        ((t =
          this.options.mainContainer === window
            ? o < a && a < o + i.$table.height()
            : o <= 0 && -o < i.$table.height()),
        i.useFixedSolution)
      ) {
        if (
          ...
          this.options.mainContainer === window && s < a - o
            ? ((e -= a - o - s),
              i.$stickyTableHeader.addClass("border-radius-fix"))
          ...
          return void i.$stickyTableHeader.css({
            visibility: "visible",
            top: e + "px",
        ...
        (e = this.options.mainContainer === window ? a - o - 1 : -o - 1) < 0
          ? (e = 0)
          : s < e && (e = s),
          this.options.mainContainer === window && 0 < n && (e -= n),
          t
            ? (i.$stickyTableHeader.css({ visibility: "visible" }),
              i.$stickyTableHeader.animate({ top: e + "px" }, 400),
              i.$thead.css({ visibility: "hidden" }))
            : i.$stickyTableHeader.animate({ top: "0" }, 400, function () {
                i.$thead.css({ visibility: "visible" }),
                  i.$stickyTableHeader.css({ visibility: "hidden" });
              });
      }
    }),
    (a.prototype.setupTableHeader = function () {
      ...
      n.$hdrCells.each(function (t) {
        var i = d(this),
          ...
          o = i.text();
        if (
          (e || ((e = n.idPrefix + t), i.prop("id", e)),
          "" === o && (o = i.attr("data-col-name")),
          i.is("[data-priority]") && -1 !== i.data("priority"))
        ) {
          var a = d(
              '<li className="checkbox-row"><input type="checkbox" name="toggle-' +
                e +
                '" id="toggle-' +
                e +
                '" value="' +
          ...
          n.$dropdownContainer.append(a),
            ...
            a
              ...
              .change(function () {
                var e = d(this),
                  t = e.val(),
                  i = n.$tableWrapper.find(
                    "#" + t + ", #" + t + "-clone, [data-columns~=" + t + "]"
                  );
                n.$table.hasClass("display-all") &&
                  (d.proxy(n.preserveDisplayAll(), n),
                  n.$table.removeClass("display-all"),
                  n.$tableClone && n.$tableClone.removeClass("display-all"),
                  n.$displayAllBtn.removeClass("btn-primary")),
                  i.each(function () {
                    var t = d(this);
                    if (e.is(":checked")) {
                      if (
                        !t.closest("thead").length &&
                        "none" !== t.css("display")
                      ) {
                        var i = Math.min(
                          parseInt(t.prop("colSpan")) + 1,
                          t.attr("data-org-colspan")
                        );
                        t.prop("colSpan", i);
                      }
                      t.show();
              ...
              .bind("updateCheck", function () {
                "none" !== i.css("display")
                  ? d(this).prop("checked", !0)
                  : d(this).prop("checked", !1);
              });
        }
      }),
        d.isEmptyObject(this.headerRowIndices) ||
          n.setupRow(this.$thead.find("tr:eq(1)"), this.headerRowIndices);
    }),
  ...
  (d.fn.responsiveTable = function (o) {
    return this.each(function () {
      ...
      "" !== e.pattern &&
        (i || t.data("responsiveTable", (i = new a(this, e))),
        "string" == typeof o && i[o]());
    });
  }),
    ...
    d(document).ready(function () {
      d("html").removeClass("no-js").addClass("js"),
        ...
        void 0 !== window.styleMedia
          ? d("html").addClass("mq")
          : d("html").addClass("no-mq"),
        "ontouchstart" in window
          ? d("html").addClass("touch")
          : d("html").addClass("no-touch");
    });
})(jQuery);

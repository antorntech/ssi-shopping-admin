    ...
    $.fn.extend({
      maxlength: function (options, callback) {
        ...
        function inputLength(input) {
          var text = input.val();
          text = options.twoCharLinebreak
            ? text.replace(/\r(?!\n)|\n(?!\r)/g, "\r\n")
            : text.replace(/(?:\r\n|\r|\n)/g, "\n");
          var currentLength = 0;
          return (
            (currentLength = options.utf8 ? utf8Length(text) : text.length),
            "file" === input.prop("type") &&
              "" !== input.val() &&
              (currentLength -= 12),
            currentLength
          );
        ...
        function updateMaxLengthHTML(
          ...
          return (
            options.message
              ...
              : (options.preText && (output += options.preText),
                options.showCharsTyped
                  ? (output += typedChars)
                  : (output += maxLengthThisInput - typedChars),
                options.showMaxLength &&
                  (output += options.separator + maxLengthThisInput),
                options.postText && (output += options.postText)),
            output
          );
        }
          ...
          maxLengthIndicator &&
            ...
            remaining > 0
              ? ((input = currentInput),
                ...
                (maxlength = maxLengthCurrentInput),
                (output = !0),
                !options.alwaysShow &&
                ...
                output
                  ...
                  : (function (currentInput, indicator) {
                      options.alwaysShow ||
                        (indicator.css({ display: "none" }),
                        currentInput.trigger("maxlength.hidden"));
                    })(currentInput, maxLengthIndicator))
              : options.limitExceededClass
              ? showRemaining(
                  currentInput,
                  0 === remaining
        ...
        function place(currentInput, maxLengthIndicator) {
          var pos = (function (currentInput) {
            ...
            return $.extend(
              {},
              "function" == typeof el.getBoundingClientRect
          ...
          if ("function" !== $.type(options.placement))
            if ($.isPlainObject(options.placement))
              !(function (placement, maxLengthIndicator) {
          ...
          this.each(function () {
            ...
            function firstInit() {
              ...
              (maxLengthCurrentInput = getMaxLength(currentInput)),
                maxLengthIndicator ||
                  (maxLengthIndicator = $(
                    '<span className="bootstrap-maxlength"></span>'
                  )
                    .css({
                      display: "none",
                      position: "absolute",
                ...
                manageRemainingVisibility(
                  remainingChars(currentInput, getMaxLength(currentInput)),
                  currentInput,
                  maxLengthCurrentInput,
                  maxLengthIndicator
                ),
            ...
            $(window).resize(function () {
              ...
              currentInput.on("input", function () {
                var maxlength = getMaxLength(currentInput),
                  ...
                  output = !0;
                return (
                  options.validate && remaining < 0
                    ? (!(function (input, maxlength) {
                        var text = input.val();
                        if (
                          (options.twoCharLinebreak &&
                            "\n" ===
                              (text = text.replace(
                                /\r(?!\n)|\n(?!\r)/g,
                                "\r\n"

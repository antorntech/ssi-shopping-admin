!(function (e) {
      ...
      if (s) {
        ...
        r.push(
          '<span title="' +
            ...
            '" className="' +
            l +
            '" role="button" tabindex="0"><span className="sp-thumb-inner" style="' +
            u +
            ';"></span></span>'
        );
      } else
        r.push(
          '<span className="sp-thumb-el sp-clear-display" role="button" tabindex="0"><span className="sp-clear-palette-only" style="background-color: transparent;"></span></span>'
        );
    }
  ...
  function n(e, t) {
    var a,
      ...
      h = (function (e, t) {
        (e.locale = e.locale || window.navigator.language),
          ...
          "en" != e.locale &&
            ...
            (e = Ne.extend({}, Ne.spectrum.localization[e.locale], e));
      ...
      ae = te
        ? Ne(Be).addClass(c).addClass(h.className).addClass(h.replacerClassName)
        : Ne([]),
      oe = te ? ae : O,
    ...
    function me() {
      if (
        ...
        Z.text(
          h.showPaletteOnly ? h.togglePaletteMoreText : h.togglePaletteLessText
        ),
        h.palette)
      ) {
    ...
    function je(e, t) {
      ...
      tinycolor.equals(e, Ae())
        ...
        : ((e && e !== De) || !ue
            ...
            : (ce = !0),
          Fe(),
          a && a.isValid() && !t && (ie = h.preferredFormat || a.getFormat()));
    }
    function Ae(e) {
      return (
        (e = e || {}),
    ...
    !(function () {
      if (
        ...
        me(),
        (fe = Ne('<span className="sp-original-input-container"></span>')),
      ...
      function a(e) {
        return (
          e.data && e.data.ignore
            ? (je(Ne(e.target).closest(".sp-thumb-el").data("color")), Re())
            : (je(Ne(e.target).closest(".sp-thumb-el").data("color")),
              Re(),
  ...
  (Ne.fn.spectrum = function (a, e) {
    ...
    (function () {
      ...
      function P(e, t) {
        t = t || 6;
        for (
          var a = h(e).toHsv(), o = a.h, r = a.s, n = a.v, s = [], i = 1 / t;
          t--;
      ...
      (h.prototype = {
        ...
        setAlpha: function (e) {
          return (
            (this._a = M(e)), (this._roundA = i(1e3 * this._a) / 1e3), this
          );
        },
        toHsv: function () {
        ...
        toName: function () {
          return 0 === this._a
            ? "transparent"
            : !(this._a < 1) && (S[t(this._r, this._g, this._b, !0)] || !1);
        },
        toFilter: function (e) {

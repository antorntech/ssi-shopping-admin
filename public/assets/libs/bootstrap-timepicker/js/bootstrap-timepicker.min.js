  ...
  (d.prototype = {
    ...
    getTemplate: function () {
      ...
      switch (
        (this.showInputs
          ? ((b =
              '<input type="text" className="bootstrap-timepicker-hour" maxlength="2"/>'),
            (c =
              '<input type="text" className="bootstrap-timepicker-minute" maxlength="2"/>'),
            (d =
              '<input type="text" className="bootstrap-timepicker-second" maxlength="2"/>'),
            (e =
              '<input type="text" className="bootstrap-timepicker-meridian" maxlength="2"/>'))
          : ((b = '<span className="bootstrap-timepicker-hour"></span>'),
            (c = '<span className="bootstrap-timepicker-minute"></span>'),
            (d = '<span className="bootstrap-timepicker-second"></span>'),
            (e = '<span className="bootstrap-timepicker-meridian"></span>')),
        (f =
          '<table><tr><td><a href="#" data-action="incrementHour"><span className="' +
          this.icons.up +
          '"></span></a></td><td className="separator">&nbsp;</td><td><a href="#" data-action="incrementMinute"><span className="' +
          this.icons.up +
          '"></span></a></td>' +
          (this.showSeconds
            ? '<td className="separator">&nbsp;</td><td><a href="#" data-action="incrementSecond"><span className="' +
              this.icons.up +
              '"></span></a></td>'
            : "") +
          (this.showMeridian
            ? '<td className="separator">&nbsp;</td><td className="meridian-column"><a href="#" data-action="toggleMeridian"><span className="' +
              this.icons.up +
              '"></span></a></td>'
            : "") +
          "</tr><tr><td>" +
          b +
          '</td> <td className="separator">:</td><td>' +
          c +
          "</td> " +
          (this.showSeconds
            ? '<td className="separator">:</td><td>' + d + "</td>"
            : "") +
          (this.showMeridian
            ? '<td className="separator">&nbsp;</td><td>' + e + "</td>"
            : "") +
          '</tr><tr><td><a href="#" data-action="decrementHour"><span className="' +
          this.icons.down +
          '"></span></a></td><td className="separator"></td><td><a href="#" data-action="decrementMinute"><span className="' +
          this.icons.down +
          '"></span></a></td>' +
          (this.showSeconds
            ? '<td className="separator">&nbsp;</td><td><a href="#" data-action="decrementSecond"><span className="' +
              this.icons.down +
              '"></span></a></td>'
            : "") +
          (this.showMeridian
            ? '<td className="separator">&nbsp;</td><td><a href="#" data-action="toggleMeridian"><span className="' +
              this.icons.down +
              '"></span></a></td>'
            : "") +
          "</tr></table>"),
        ...
        case "modal":
          a =
            '<div className="bootstrap-timepicker-widget modal hide fade in" data-backdrop="' +
            (this.modalBackdrop ? "true" : "false") +
            '"><div className="modal-header"><a href="#" className="close" data-dismiss="modal">&times;</a><h3>Pick a Time</h3></div><div className="modal-content">' +
            f +
            '</div><div className="modal-footer"><a href="#" className="btn btn-primary" data-dismiss="modal">OK</a></div></div>';
          break;
        case "dropdown":
          a =
            '<div className="bootstrap-timepicker-widget dropdown-menu">' +
            f +
            "</div>";
      }
      return a;

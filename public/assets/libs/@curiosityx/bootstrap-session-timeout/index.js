  ...
  a.sessionTimeout = function (b) {
    ...
    if ("function" != typeof i.onWarn) {
      var k = i.countdownMessage
          ...
          : "",
        l = i.countdownBar
          ? '<div className="progress">                   <div className="progress-bar progress-bar-striped countdown-bar active" role="progressbar" style="min-width: 15px; width: 100%;">                     <span className="countdown-holder"></span>                   </div>                 </div>'
          : "";
      a("body").append(
        '<div className="modal fade" id="session-timeout-dialog">               <div className="modal-dialog">                 <div className="modal-content">                   <div className="modal-header">                     <button type="button" className="close" data-dismiss="modal" aria-hidden="true">&times;</button>                     <h4 className="modal-title">' +
          i.title +
          '</h4>                   </div>                   <div className="modal-body">                     <p>' +
          i.message +
          "</p>                     " +
          k +
          "                     " +
          l +
          '                   </div>                   <div className="modal-footer">                     <button id="session-timeout-dialog-logout" type="button" className="btn btn-default">' +
          i.logoutButton +
          '</button>                     <button id="session-timeout-dialog-keepalive" type="button" className="btn btn-primary" data-dismiss="modal">' +
          i.keepAliveButton +

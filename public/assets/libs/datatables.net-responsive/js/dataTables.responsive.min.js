            ...
            i
              ...
              .on("init.dtr", function (e, t, n) {
                "dt" === e.namespace &&
                  (s._resizeAuto(),
                  s._resize(),
                  f.inArray(!1, s.s.current) && i.columns.adjust());
              }),
            this._resize();
        },
              ...
              return function (e, t, n, i) {
                if (t) {
                  ...
                  var r = function () {
                    ...
                    s = f('<div className="dtr-modal"/>')
                      .append(
                        f('<div className="dtr-modal-display"/>')
                          .append(
                            f('<div className="dtr-modal-content"/>')
                              .data("dtr-row-idx", e.index())
                              .append(n())
                          )
                          .append(
                            f(
                              '<div className="dtr-modal-close">&times;</div>'
                            ).click(function () {
                              r();
                            })
                          )
                      ...
                      .append(
                        f('<div className="dtr-modal-background"/>').click(
                          function () {
                            r();
                          }
                        )
          ...
          renderer: (a.renderer = {
            listHiddenNodes: function () {
              return function (i, e, t) {
                var r = this,
                  s = f(
                    '<ul data-dtr-index="' + e + '" className="dtr-details"/>'
                  ),
                  o = !1;
                f.each(t, function (e, t) {
                  var n;
                  t.hidden &&
                    ((n = t.className ? 'className="' + t.className + '"' : ""),
                    f(
                      "<li " +
                        n +
                        ' data-dtr-index="' +
                      ...
                      .append(
                        f('<span className="dtr-data"/>').append(
            ...
            listHidden: function () {
              return function (e, t, n) {
                ...
                return (
                  !!n &&
                  f(
                    '<ul data-dtr-index="' + t + '" className="dtr-details"/>'
                  ).append(n)
                );
              };
            },

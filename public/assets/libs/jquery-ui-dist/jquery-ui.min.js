...
!(function (t) {
  ...
  function st() {
    (this._curInst = null),
      ...
      (this._inlineclassName = "ui-datepicker-inline"),
      (this._appendclassName = "ui-datepicker-append"),
      (this._triggerclassName = "ui-datepicker-trigger"),
      (this._dialogclassName = "ui-datepicker-dialog"),
      (this._disableclassName = "ui-datepicker-disabled"),
      (this._unselectableclassName = "ui-datepicker-unselectable"),
      (this._currentclassName = "ui-datepicker-current-day"),
      (this._dayOverclassName = "ui-datepicker-days-cell-over"),
      (this.regional = []),
      (this.regional[""] = {
        closeText: "Done",
        prevText: "Prev",

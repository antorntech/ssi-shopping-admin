...
!(function (t) {
    ...
    ? ((n = require("jquery")),
      ...
      "undefined" == typeof window
        ? (module.exports = function (e, a) {
            return (
              (e = e || window), (a = a || n(e)), o(e, a), t(a, 0, e.document)
            );
          })
        : (o(window, n), (module.exports = t(n, window, window.document))))
  ...
  return (
    ...
    (r.ext.renderer.pageButton.bootstrap = function (i, e, d, a, l, c) {
          ...
          if (((t = a[r]), Array.isArray(t))) u(e, t);
            ...
            p &&
              ...
              (n = x("<li>", {
                ...
                id:
                  0 === d && "string" == typeof t ? i.sTableId + "_" + t : null,
              })
                .append(
                  x("<a>", {
                    href: n ? null : "#",
      ...
      u(x(e).empty().html('<ul className="pagination"/>').children("ul"), a),
        t !== o &&
          x(e)
            .find("[data-dt-idx=" + t + "]")
            .trigger("focus");

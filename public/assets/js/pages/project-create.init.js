!(function () {
    ...
    document
      ...
      .addEventListener("change", function () {
        var e = document.querySelector("#projectlogo-img"),
          t = document.querySelector("#project-image-input").files[0],
          a = new FileReader();
        a.addEventListener(
          "load",
          function () {
  ...
  var o,
    r = sessionStorage.getItem("editInputValue");
  r &&
    ((r = JSON.parse(r)),
    ...
    Array.from(
      document.querySelectorAll("#select-element .dropdown-menu ul li a")
    ).forEach(function (o) {
        ...
        return (
          e.assigneeName == n &&
            ...
            o.classList.contains("active") &&
              ((a =
                '<a href="#" className="avatar-group-item mb-2" data-img="' +
                e.assigneeImg +
          ...
          if (p.checkValidity()) {
            ...
            var t = ++v,
              ...
              c = document.querySelectorAll(
                "#select-element .assignto-list li a.active"
              );
            0 < c.length &&
            ...
            var l,
              ...
              d,
              m,
              g = document.getElementById("formAction").value;
            return (
              "add" == g
                ? (null != sessionStorage.getItem("inputValue")
                    ? ((l = JSON.parse(sessionStorage.getItem("inputValue"))),
                      (u = {
                        id: t + 1,
                        projectLogoImg: n,
                        projectTitle: a,
                  ...
                  sessionStorage.setItem("inputValue", JSON.stringify(l)))
                : "edit" == g
                ? ((d = document.getElementById("project-id-input").value),
  ...
  Array.from(
    document.querySelectorAll("#select-element .assignto-list li a")
  ).forEach(function (i) {
    i.addEventListener("click", function () {
      ...
      var t,
        a,
        o,
        n = i.querySelector(".avatar-xs img").getAttribute("src"),
        r = document.getElementById("assignee-member");
      i.classList.contains("active")
        ? ((t = i.querySelector(".flex-grow-1").innerHTML),
          (a =
            '<a href="#" className="avatar-group-item mb-2" data-img="' +
            n +
            '"  data-bs-toggle="tooltip" data-bs-placement="top" title="' +
        ...
        : Array.from(r.querySelectorAll(".avatar-group-item")).forEach(
            function (e) {
              var t = e.getAttribute("data-img");
              n == t && e.remove();
            }
          ),
        (o = document.querySelectorAll('[data-bs-toggle="tooltip"]')),
        []
          .concat(
            (function (e) {
              {

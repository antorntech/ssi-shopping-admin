    ...
    $("#closeButton").click(function () {
      ...
      $("#showtoast").click(function () {
        ...
        (toastr.options = {
          ...
          r.val().length &&
            (toastr.options.timeOut = v ? 0 : parseInt(r.val())),
          l.val().length &&
            (toastr.options.extendedTimeOut = v ? 0 : parseInt(l.val())),
          ...
          v &&
            ((t = (t = a) || "Clear itself?"),
            (a = t +=
              '<br /><br /><button type="button" className="btn-primary btn clear">Yes</button>'),
            (toastr.options.tapToDismiss = !1)),
          a ||
            (++k ===
              (o = [
                "My name is Inigo Montoya. You killed my father. Prepare to die!",
                '<div><input className="input-small form-control form-control-sm mb-2" placeholder="textbox"/>&nbsp;<a href="" target="_blank">This is a hyperlink</a></div><div><button type="button" id="okBtn" className="btn btn-primary mt-2">Close me</button><button type="button" id="surpriseBtn" className="btn text-white  mt-2" style="margin: 0 8px 0 8px">Surprise me</button></div>',

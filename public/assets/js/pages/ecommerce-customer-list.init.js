    ...
    columns: [
      {
        ...
        render: function (e, t, a) {
          return (
            ...
            a.id +
            '</div>                    <div className="form-check font-size-16">                        <input className="form-check-input" type="checkbox" id="customerlistcheck-' +
            a.id +
            '">                        <label className="form-check-label" for="customerlistcheck-' +
            a.id +
            '"></label>                    </div>'
          );
        },
      ...
      { data: "phone" },
      {
        ...
        render: function (e, t, a) {
          return (
            '<span className="badge bg-success font-size-12"><i className="mdi mdi-star me-1"></i> ' +
            a.rating +
            "</span>"
          );
        },
      ...
      { data: "joinDate" },
      {
        ...
        render: function (e, t, a) {
          return (
            '<div className="dropdown">                <a href="#" className="dropdown-toggle card-drop" data-bs-toggle="dropdown" aria-expanded="false">                    <i className="mdi mdi-dots-horizontal font-size-18"></i>                </a>                <ul className="dropdown-menu dropdown-menu-end">                    <li><a href="#newCustomerModal" data-bs-toggle="modal" className="dropdown-item edit-list" data-edit-id="' +
            a.id +
            ...
            a.id +
            '"><i className="mdi mdi-trash-can font-size-16 text-danger me-1"></i> Delete</a></li>                </ul>            </div>'
          );
        },
      },
    ],
    ...
    t.addEventListener("click", function (e) {
      (a = t.getAttribute("data-edit-id")),
        ...
        (customerListData = customerListData.map(function (e) {
          return (
            e.id == a &&
              ((document.getElementById("newCustomerModalLabel").innerHTML =
                "Edit Profile"),
              ...
              (document.getElementById("phone-input").value = e.phone),
              $("#joindate-input").datepicker("setDate", e.joinDate)),
            e
          );
        }));
    });

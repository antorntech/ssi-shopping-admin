  ...
  $("#NewtaskForm").validate({
    ...
    $("#addtask").click(function () {
      ...
      for (
        ...
        k =
          k +
          '<div className="avatar-group-item"><a href="#" className="d-inline-block" value="' +
          c[i] +
          '"><img src="' +
          r[i] +
          '" className="rounded-circle avatar-xs" alt=""></a></div>';
        ...
        0 == r.length
          ...
          : ($(taskid).append(
              "<div class='card task-box' id='" +
                ...
                "' id='task-status'>" +
                selectedstatus +
                "</span></div><div><h5 class='font-size-15'><a href='#' class='text-dark' id='task-name'>" +
                t +

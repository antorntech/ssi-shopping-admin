    ...
    columns: [
      {
        ...
        render: function (e, t, a) {
          return (
            '<div className="form-check font-size-16">                        <input className="form-check-input" type="checkbox" id="orderlistIdCheck-' +
            a.id +
            '">                        <label className="form-check-label" for="orderlistIdCheck-' +
            a.id +
            '"></label>                    </div>'
          );
        },
      },
      {
        ...
        render: function (e, t, a) {
          return (
            '<a href="#" className="text-body orderlist-id fw-bold">#SK' +
            a.id +
            "</a>"
          );
        },
      },
      {
        data: "billName",
        render: function (e, t, a) {
          return '<div className="customerlist-name">' + a.billName + "</div>";
        },
      },
      { data: "date" },
      { data: "totalPay" },
      ...
      },
      {
        ...
        bSortable: !1,
        render: function (e, t, a) {
          return '<button type="button" className="btn btn-primary btn-sm btn-rounded viewdetail-btn" data-bs-toggle="modal" data-bs-target=".orderdetailsModal">View Details</button>';
        },
      },
      {
        data: null,
        ...
        render: function (e, t, a) {
          return (
            '<div className="d-flex gap-3">                    <a href="#newOrderModal" data-bs-toggle="modal" className="text-success edit-list" data-edit-id="' +
            a.id +
            '"><i className="mdi mdi-pencil font-size-18"></i></a>                    <a href="#removeItemModal" data-bs-toggle="modal" className="text-danger remove-list" data-remove-id="' +
            a.id +
            '"><i className="mdi mdi-delete font-size-18"></i></a>                </div>'
          );
        },
      },
    ],
...
function isMethod(e) {
  switch (e) {
    case "Mastercard":
      return (
        '<div><i className="fab fa-cc-mastercard me-1"></i>' + e + "</div>"
      );
    case "Visa":
      return '<div><i className="fab fa-cc-visa me-1"></i>' + e + "</div>";
    case "Paypal":
      return '<div><i className="fab fa-cc-paypal me-1"></i>' + e + "</div>";
    case "COD":
      return (
        '<div><i className="fas fa-money-bill-alt me-1"></i>' + e + "</div>"
      );
  }
}

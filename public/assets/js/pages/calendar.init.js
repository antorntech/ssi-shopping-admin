...
!(function (e, t) {
  ...
  function o(e, t) {
    ...
    return (
      ...
      e.isPrivate
        ? (n.push('<span className="calendar-font-icon ic-lock-b"></span>'),
          n.push(" Private"))
        : (e.isReadOnly
            ? n.push(
                '<span className="calendar-font-icon ic-readonly-b"></span>'
              )
            : e.recurrenceRule
            ? n.push('<span className="calendar-font-icon ic-repeat-b"></span>')
            : e.attendees.length
            ? n.push('<span className="calendar-font-icon ic-user-b"></span>')
            : e.location &&
              n.push(
                '<span className="calendar-font-icon ic-location-b"></span>'
              ),
          n.push(" " + e.title)),
      n.join("")
    );
  ...
  function u(e) {
    ...
    (t = r),
      ...
      (a = findCalendar(t)),
      (o = []).push(
        '<span className="calendar-bar" style="background-color: ' +
          a.bgColor +
          "; border-color:" +
          a.borderColor +
          ';"></span>'
      ),
      o.push('<span className="calendar-name">' + a.name + "</span>"),
      (n.innerHTML = o.join("")),
      (i = a);
  }
  function g(e) {
  ...
  (l = new t("#calendar", {
    ...
    template: {
      milestone: function (e) {
        return (
          '<span className="calendar-font-icon ic-milestone-b"></span> <span style="background-color: ' +
          e.bgColor +
          '">' +
          e.title +
          "</span>"
  ...
  (function () {
    ...
    CalendarList.forEach(function (e) {
      t.push(
        '<div className="lnb-calendars-item"><label><input type="checkbox" className="tui-full-calendar-checkbox-round" value="' +
          e.id +

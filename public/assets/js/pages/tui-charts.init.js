...
var barChartWidth,
  barChart,
  barChartColors = getChartColorsArray("bar-charts");
barChartColors &&
  ...
  (theme = {
    ...
    series: { colors: barChartColors },
    legend: { label: { color: "#8791af" } },
  }),
  tui.chart.registerTheme("myTheme", theme),
  (options.theme = "myTheme"),
  (barChart = tui.chart.barChart(container, data, options))),
  $(window).resize(function () {
    (barChartWidth = $("#bar-charts").width()),
      barChart.resize({ width: barChartWidth, height: 350 });
  });
var columnChartWidth,
  columnChart,
  columnChartColors = getChartColorsArray("column-charts");
columnChartColors &&
  ...
  (theme = {
    ...
    plot: { lineColor: "rgba(166, 176, 207, 0.1)" },
    legend: { label: { color: "#8791af" } },
    series: { colors: columnChartColors },
  }),
  tui.chart.registerTheme("myTheme", theme),
  (options.theme = "myTheme"),
  (columnChart = tui.chart.columnChart(container, data, options))),
  $(window).resize(function () {
    (columnChartWidth = $("#column-charts").width()),
...
var lineChartWidth,
  lineChart,
  lineChartColors = getChartColorsArray("line-charts");
lineChartColors &&
  ...
  (theme = {
    ...
    plot: { lineColor: "rgba(166, 176, 207, 0.1)" },
    legend: { label: { color: "#8791af" } },
    series: { colors: lineChartColors },
  }),
  tui.chart.registerTheme("myTheme", theme),
  (options.theme = "myTheme"),
  (lineChart = tui.chart.lineChart(container, data, options))),
  $(window).resize(function () {
    (lineChartWidth = $("#line-charts").width()),
...
var areaChartWidth,
  areaChart,
  areaChartColors = getChartColorsArray("area-charts");
areaChartColors &&
...
var radialChartWidth,
  radialChart,
  radialChartColors = getChartColorsArray("radial-charts");
radialChartColors &&
  ...
  (theme = {
    ...
    plot: { lineColor: "rgba(166, 176, 207, 0.1)" },
    legend: { label: { color: "#8791af" } },
    series: { colors: radialChartColors },
  }),
  tui.chart.registerTheme("myTheme", theme),
  (options.theme = "myTheme"),
  (radialChart = tui.chart.radialChart(container, data, options))),
  $(window).resize(function () {
    (radialChartWidth = $("#radial-charts").width()),
...
var bubbleChartWidth,
  bubbleChart,
  bubbleChartColors = getChartColorsArray("bubble-charts");
bubbleChartColors &&
  ...
  (options = {
    chart: {
      ...
      format: function (t, e, a, r) {
        return (
          ("r" !== r && "x" !== r) ||
            ((t = tui.chart.renderUtil.formatToComma(t)),
            "x" === r && (t = "$" + t)),
          t
        );
      },
    ...
    tooltip: {
      template: function (t, e) {
        return (
          '<div className="tui-chart-default-tooltip"><div className="tui-chart-tooltip-head"><span className="tui-chart-legend-rect" style="' +
          e.cssText +
          '; width: 10px; height: 10px"></span><span>' +
          e.legend +
          "</span><span>" +
          e.label +
          '</span></div><table className="tui-chart-tooltip-body"><tr><td>GDP</td><td className="tui-chart-tooltip-value">' +
          e.x +
          '</td></tr><tr><td>Life Expectancy</td><td className="tui-chart-tooltip-value">' +
          e.y +
          '</td></tr><tr><td>Population</td><td className="tui-chart-tooltip-value">' +
          e.r +
          "</td></tr></table>"
        );
      },
  ...
  (theme = {
    ...
    plot: { lineColor: "rgba(166, 176, 207, 0.1)" },
    legend: { label: { color: "#8791af" } },
    series: { colors: bubbleChartColors },
  }),
  tui.chart.registerTheme("myTheme", theme),
  (options.theme = "myTheme"),
  (bubbleChart = tui.chart.bubbleChart(container, data, options))),
  $(window).resize(function () {
    (bubbleChartWidth = $("#bubble-charts").width()),
      bubbleChart.resize({ width: bubbleChartWidth, height: 350 });
  });
var scatterChartWidth,
  scatterChart,
  scatterChartColors = getChartColorsArray("bubble-charts");
scatterChartColors &&
  ...
  (options = {
    ...
    tooltip: {
      template: function (t, e) {
        return (
          '<div className="tui-chart-default-tooltip"><div className="tui-chart-tooltip-head">' +
          e.legend +
          '</div><table className="tui-chart-tooltip-body"><tr><td>Weight</td><td className="tui-chart-tooltip-value">' +
          e.x +
          'kg</td></tr><tr><td>Height</td><td className="tui-chart-tooltip-value">' +
          e.y +
          "cm</td></tr></table></div>"
        );
      },
  ...
  (theme = {
    ...
    plot: { lineColor: "rgba(166, 176, 207, 0.1)" },
    legend: { label: { color: "#8791af" } },
    series: { colors: scatterChartColors },
  }),
  tui.chart.registerTheme("myTheme", theme),
  (options.theme = "myTheme"),
  (scatterChart = tui.chart.scatterChart(container, data, options))),
  $(window).resize(function () {
    (scatterChartWidth = $("#scatter-charts").width()),
...
var pieChartWidth,
  pieChart,
  pieChartColors = getChartColorsArray("pie-charts");
pieChartColors &&
...
var donutpieChartWidth,
  donutChart,
  donutPieChartColors = getChartColorsArray("donut-charts");
donutPieChartColors &&
  ...
  tui.chart.registerTheme("myTheme", theme),
  (options.theme = "myTheme"),
  (donutChart = tui.chart.pieChart(container, data, options))),
  $(window).resize(function () {
    (donutpieChartWidth = $("#donut-charts").width()),
      donutChart.resize({ width: donutpieChartWidth, height: 350 });
  });
var heatmapchartsWidth,
  heatmapChart,
  heatMapChartColors = getChartColorsArray("heatmap-charts");
heatMapChartColors &&
  ((heatmapchartsWidth = $("#heatmap-charts").width()),
  ...
  tui.chart.registerTheme("myTheme", theme),
  (options.theme = "myTheme"),
  (heatmapChart = tui.chart.heatmapChart(container, data, options))),
  $(window).resize(function () {
    (heatmapChartChartWidth = $("#heatmap-charts").width()),
      heatmapChart.resize({ width: heatmapChartChartWidth, height: 350 });
  });
var treemapchartsWidth,
  treemapChart,
  treemapChartColors = getChartColorsArray("treemap-charts");
treemapChartColors &&
  ((treemapchartsWidth = $("#treemap-charts").width()),
  ...
  tui.chart.registerTheme("myTheme", theme),
  (options.theme = "myTheme"),
  (treemapChart = tui.chart.treemapChart(container, data, options))),
  $(window).resize(function () {
...
var mapchartsWidth,
  mapChart,
  mapChartColors = getChartColorsArray("map-charts");
mapChartColors &&
  ((mapchartsWidth = $("#map-charts").width()),
  ...
  tui.chart.registerTheme("myTheme", theme),
  (options.theme = "myTheme"),
  (mapChart = tui.chart.mapChart(container, data, options))),
  $(window).resize(function () {
    (mapChartChartWidth = $("#map-charts").width()),
      mapChart.resize({ width: mapChartChartWidth, height: 350 });
  });
var boxplotchartsWidth,
  boxplotChart,
  boxPlotChartColors = getChartColorsArray("boxplot-charts");
boxPlotChartColors &&
  ((boxplotchartsWidth = $("#boxplot-charts").width()),
  ...
  (theme = {
    ...
    plot: { lineColor: "rgba(166, 176, 207, 0.1)" },
    legend: { label: { color: "#8791af" } },
    series: { colors: boxPlotChartColors },
  }),
  tui.chart.registerTheme("myTheme", theme),
  (options.theme = "myTheme"),
  (boxplotChart = tui.chart.boxplotChart(container, data, options))),
  $(window).resize(function () {
    (boxplotChartChartWidth = $("#boxplot-charts").width()),
      boxplotChart.resize({ width: boxplotChartChartWidth, height: 350 });
  });
var bulletchartsWidth,
  container,
  data,
  options,
  theme,
  bulletChart,
  bulletChartColors = getChartColorsArray("bullet-charts");
bulletChartColors &&
  ((bulletchartsWidth = $("#bullet-charts").width()),
  ...
  tui.chart.registerTheme("myTheme", theme),
  (options.theme = "myTheme"),
  (bulletChart = tui.chart.bulletChart(container, data, options))),
  $(window).resize(function () {

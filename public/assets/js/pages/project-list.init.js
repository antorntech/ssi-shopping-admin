    ...
    columns: [
      {
        ...
        render: function (t, e, a) {
          return (
            ...
            a.id +
            '</div><div className="avatar-sm bg-light rounded p-2">                    <img src="' +
            a.projectLogoImg +
            '" alt="" className="img-fluid rounded-circle">                    </div>'
          );
        },
      },
      {
        ...
        render: function (t, e, a) {
          return (
            '<div>                    <h5 className="text-truncate font-size-14"><a href="#" className="text-dark">' +
            a.projectTitle +
      ...
      },
      {
        ...
        render: function (t, e, a) {
          var s,
            r = a.assignedto,
            i = '<div className="avatar-group">';
          return (
            Array.from(r.slice(0, 3)).forEach(function (t) {
              i +=
                '<a href="#" className="avatar-group-item" data-img="' +
                t.assigneeImg +
                '"  data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="' +
                t.assigneeName +
                '">                                    <img src="' +
                t.assigneeImg +
                '" alt="" className="rounded-circle avatar-xs" />                                </a>';
            }),
            3 < r.length &&
              ((s = r.length - 3),
              (i +=
                '<a href="#" className="avatar-group-item"  data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="' +
                s +
                ' More">                        <div className="avatar-xs">                        <div className="avatar-title rounded-circle">' +
                s +
                "+</div>                        </div>                    </a>")),
            (i += "</div>")
          );
      ...
      },
      {
        ...
        render: function (t, e, a) {
          return (
            '<div className="dropdown">                <a href="#" className="dropdown-toggle card-drop" data-bs-toggle="dropdown" aria-expanded="false">                    <i className="mdi mdi-dots-horizontal font-size-18"></i>                </a>                <ul className="dropdown-menu dropdown-menu-end">                    <li><a href="projects-create.html" className="dropdown-item edit-list" data-edit-id="' +
            a.id +
            ...
            a.id +
            '"><i className="mdi mdi-trash-can font-size-16 text-danger me-1"></i> Remove</a></li>                </ul>            </div>'
          );
        },
      },
    ],
...
function isStatus(t) {
  switch (t) {
    case "Completed":
      return '<span className="badge bg-success">' + t + "</span>";
    case "Inprogress":
      return '<span className="badge bg-warning">' + t + "</span>";
    case "Delay":
      return '<span className="badge bg-danger">' + t + "</span>";
  }
}
